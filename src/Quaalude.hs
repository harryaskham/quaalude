...
import Data.PQueue.Prio.Min as X (assocsU, deleteFindMin, elemsU, foldMapWithKeyU, foldlU, foldlU', foldlWithKeyU, foldlWithKeyU', foldrU, foldrWithKeyU, keysU, takeWhileWithKey, toListU, traverseU, traverseWithKeyU)
